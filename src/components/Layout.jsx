...
// Contains the header (logo, nav, user badge, What-If toggle)
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
      ...
      <header style={{
        ...
        borderBottom: '2px solid var(--vx-yellow)',
        display: 'flex',
        alignItems: 'center',
        padding: '0 20px',
        height: '52px',
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <img src="/vac-ex-logo.png" alt="Vac-Ex" height="36"
               style={{ display: 'block' }}
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '18px' }}>
          ...
          {/* What-If toggle — only visible on schedule */}
          {isSchedule && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '9px' }}>
              <span style={{
                fontSize: '12px',
                fontWeight: 500,
                color: whatIfOn ? 'var(--amber-txt)' : 'var(--vx-muted)',
              }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: whatIfOn ? 'var(--amber)' : 'var(--vx-border)',
              ...
              >
                <span style={{
                  ...
                  left: whatIfOn ? '21px' : '3px', transition: 'left .2s',
                }} />
              </button>
            </div>
          )}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}
            ...
            <div style={{
              ...
              fontSize: '11px', fontWeight: 700, color: 'var(--vx-black)',
            }}>
              {initials}
            </div>
